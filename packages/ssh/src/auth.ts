...
# Invoked by ssh via SSH_ASKPASS when Atlas re-runs ssh with a cached password
...
printf 'Atlas ssh-askpass invoked without T3_SSH_AUTH_SECRET.\\n' >&2
exit 1
`;
...
export const ASKPASS_WINDOWS_SCRIPT = `# Invoked by ssh via SSH_ASKPASS (through ssh-askpass.cmd) when Atlas re-runs\r
...
[Console]::Error.WriteLine("Atlas ssh-askpass invoked without T3_SSH_AUTH_SECRET.")\r
exit 1\r
`;
