...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    setAutoShip: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:set-auto-ship",
      execute: (input: SetThreadAutoShipInput) => setThreadAutoShip(input),
      scheduler,
      concurrency,
    }),
