...
const defaultEnvironmentInput = {
  ...
  processArch: "arm64",
  appVersion: "1.2.3",
  appPath: "/Applications/Atlas.app/Contents/Resources/app.asar",
  isPackaged: true,
  ...
  it.effect("configures app identity from the environment commit override", () => {
    ...
    return withIdentity(
      Effect.gen(function* () {
        ...
        assert.deepEqual(calls.setName, ["Atlas"]);
        assert.equal(calls.setAboutPanelOptions[0]?.applicationName, "Atlas");
