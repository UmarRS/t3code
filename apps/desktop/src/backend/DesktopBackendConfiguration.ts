...
// Cleared from the backend child's environment so an ambient value can't
// override what the desktop resolves for it.
...
export const make = Effect.gen(function* () {
  ...
  // crypto.randomBytes is a yield point, so modifyEffect serializes the whole
  // get-or-create and the first caller's token is the one everyone reuses.
