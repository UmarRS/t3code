...
const T3_CHAT_LIGHT_COLORS: ThemeColors = {
  canvas: "#fdf7fd",
  // Atlas's workspace header belongs to the chat panel, so keep it seamless
  ...
  // dark plum pair here also leaked the dark palette into Atlas's diffs.
...
const T3_CHAT_DARK_COLORS: ThemeColors = {
  ...
  // Diffs and file previews are full workspace surfaces in Atlas. Keep them
...
/**
 * The palette Atlas wears with no theme installed, captured from the app's
...
/**
 * The standard Atlas look as a theme palette, for seeding a new theme when
...
/**
 * The status colors Atlas shows without a theme, read from the app's own
...
export function serializeThemeFile(theme: ThemeDefinition): string {
  ...
  const file: ThemeFile = {
    ...
    ...(canonicalTheme.sidebarArtwork ? { sidebarArtwork: true } : {}),
