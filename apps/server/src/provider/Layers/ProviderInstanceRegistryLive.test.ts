...
describe("ProviderInstanceRegistryLive — all drivers slice", () => {
  ...
  // Path), which also satisfies `ServerConfig.layerTest`'s `FileSystem` dep
  // while staying surfaced to the test.
  ...
  it.live("boots one instance of every shipped driver from a single config map", () =>
    Effect.gen(function* () {
      ...
      // distinct references even when two instances share a trait; they
      // must still be different object values.
