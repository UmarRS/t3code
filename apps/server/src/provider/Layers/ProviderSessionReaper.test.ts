...
function makeReadModel(
  ...
  return {
    ...
    threads: threads.map((thread) => ({
      ...
      latestTurn: null,
      messages: [],
      session: thread.session === null ? null : { ...thread.session, resumeAt: null },
    ...
    const layer = makeProviderSessionReaperLive({
      ...
      Layer.provideMerge(
        Layer.succeed(ProjectionSnapshotQuery, {
          ...
          getProjectLinksById: () => Effect.die("unused"),
          getCompanionThreadId: () => Effect.die("unused"),
          listScheduledProjects: () => Effect.die("unused"),
          listThreadIdsDueForResume: () => Effect.die("unused"),
