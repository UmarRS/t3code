    ...
    Effect.gen(function* () {
      ...
      if (event.type === "turn.completed") {
        ...
        if (turnId) {
          ...
          // Run last: the assistant text is final only after the finalize
          // dispatches above have landed. Story decomposition is deliberately
          // user-applied from chat so a revised plan never creates stale issues.
