...
import Migration0041 from "./Migrations/041_ProjectionThreadsScope.ts";
import Migration0042 from "./Migrations/042_ProjectionIssues.ts";
...
import Migration0049 from "./Migrations/049_ProjectionThreadSessionsResumeAt.ts";
import Migration0050 from "./Migrations/050_ProjectionThreadsAutoShip.ts";
import Migration0051 from "./Migrations/051_ProjectionIssuesAttentionKind.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadsScope", Migration0041],
  [42, "ProjectionIssues", Migration0042],
  ...
  [49, "ProjectionThreadSessionsResumeAt", Migration0049],
  [50, "ProjectionThreadsAutoShip", Migration0050],
  [51, "ProjectionIssuesAttentionKind", Migration0051],
] as const;
