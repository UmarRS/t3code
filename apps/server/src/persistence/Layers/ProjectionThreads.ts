    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.worktreePath},
          ${row.focusPath ?? null},
          ${JSON.stringify(row.linkedPaths ?? [])},
          ${row.parentThreadId ?? null},
          ${row.originLinkId ?? null},
          ${row.latestTurnId},
          ${row.createdAt},
          ${row.updatedAt},
          ${row.archivedAt},
        ...
        DO UPDATE SET
          ...
          origin_link_id = excluded.origin_link_id,
          ...
          auto_ship_enabled_at = excluded.auto_ship_enabled_at,
