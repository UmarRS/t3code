...
T3 Code is a minimal GUI for coding agents. A Node WebSocket server wraps provider CLIs (Codex, Claude Code) and serves the web UI and the Electron desktop shell.
...
- **provider** means the agent runtime or harness T3 Code talks to: Codex or Claude.
